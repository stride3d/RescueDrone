...
namespace RescueDrone
{
    ...
    public class FreeCamera : AsyncScript
    {
        ...
        protected virtual void UpdateCamera()
        {
            ...
            var isMouseInput = Input.MousePosition.Y < 0.8;
            if (isMouseInput)
            {
            ...
            var rotateCamera = isMouseInput && (Input.IsMouseButtonDown(MouseButton.Left) || Input.IsMouseButtonDown(MouseButton.Right)) || touchingFingers == 1;
            if (rotateCamera)
            {
            ...
            // Dolly
            else if (!isAdaptingOrientation && isMouseInput)
            {
